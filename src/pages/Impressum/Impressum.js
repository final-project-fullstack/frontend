...
const Impressum = () => {
  return (
    <div className={style.impressum}>
      ...
      <p>
        <b>Umsatzsteuer-ID:</b>
        <br /> Umsatzsteuer-Identifikationsnummer gemäß §27a Umsatzsteuergesetz:
        Musterustid.
      </p>
      <p>
        <b>Wirtschafts-ID:</b>
        <br /> Musterwirtschaftsid
      </p>
      <p>
        <b>Aufsichtsbehörde:</b>
        <br /> Musteraufsicht Musterstadt
      </p>
      <p>
      ...
      <p>
        ...
        Einstellungen, Datenschutz, Cookies''); wir weisen Sie jedoch darauf
        hin, dass Sie in diesem Fall gegebenenfalls nicht sämtliche Funktionen
        dieser Website voll umfänglich nutzen können. Durch die Nutzung dieser
